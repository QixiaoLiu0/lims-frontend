      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 py-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl border-2 border-slate-300 dark:border-slate-700 p-6 mb-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold text-[#0a1629] dark:text-slate-100 mb-2">
                {sampleClientId}
              </h2>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium rounded-lg hover:bg-slate-300 dark:hover:bg-slate-600 transition shadow-sm"
              >
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl border-2 border-slate-300 dark:border-slate-700 overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-400 dark:border-slate-600 flex items-center justify-between bg-slate-50 dark:bg-slate-800/50">
            <h3 className="text-lg font-semibold text-[#0a1629] dark:text-slate-100 flex items-center gap-2">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium rounded-lg hover:bg-blue-100 hover:text-blue-700 dark:hover:bg-blue-900/50 dark:hover:text-blue-300 transition shadow-sm"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition shadow-lg"
              >
