...
export default function ManageTestTypesModal({ canEdit }) {
  ...
  if (loading) {
    return (
      <div className="p-8 text-center text-sm font-medium text-gray-500 dark:text-gray-200">
    ...
    <div className="w-full flex flex-col">
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 w-full flex flex-col shadow-sm overflow-hidden">
        ...
        <div className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700 px-6 py-5 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-200 tracking-tight leading-tight">
              {canEdit ? "Manage Test Types" : "View Test Types"}
            </h2>
            <p className="text-sm text-gray-500 dark:text-gray-200 mt-1 font-medium leading-tight">
                  ...
                  <div className="space-y-5">
                    <div className="flex items-center justify-between mb-2 border-b border-slate-100 dark:border-slate-700 pb-4">
                      <div className="flex items-center gap-3">
                        <div className="text-xs font-medium text-gray-500 dark:text-gray-200 bg-slate-100 dark:bg-slate-700 px-2 py-1 rounded">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-4 py-2 bg-slate-100 dark:bg-slate-700 text-gray-900 dark:text-gray-200 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors text-sm font-medium leading-tight"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900 dark:text-gray-200 text-sm transition-colors"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-semibold text-gray-900 dark:text-gray-200 mb-2 leading-tight">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none text-gray-900 dark:text-gray-200 text-sm transition-colors"
                      />
                    </div>
                        ...
                        {(editForm.parameters || []).map((param) => (
                          ...
                          >
                            <input
                              ...
                              className="flex-1 px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm text-gray-900 dark:text-gray-200 transition-colors placeholder-slate-400 dark:placeholder-slate-500"
                            />
                            <input
                              type="text"
                              value={param.unit || ""}
                              ...
                              placeholder="Unit"
                              className="w-28 px-3 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-sm text-gray-900 dark:text-gray-200 transition-colors placeholder-slate-400 dark:placeholder-slate-500"
                            />
                            <input
                              type="text"
                              value={param.limit || ""}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div>
                            ...
                            testType.parameters.length > 0 ? (
                              <div className="flex flex-wrap gap-2">
                                {testType.parameters.map((param, i) => (
                                  <span
                                    ...
                                    className="inline-flex items-center px-2.5 py-1 rounded-md bg-slate-50 dark:bg-slate-800 text-gray-900 dark:text-gray-200 text-xs font-semibold border border-slate-200 dark:border-slate-700 leading-tight"
                                  >
                                    {param.parameterName}{" "}
                              ...
                              <p className="text-xs font-medium text-gray-500 dark:text-gray-200 italic">
                          ...
                          <>
                            <button
                              ...
                              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors border ${
                                testType.isActive === 1
                                  ? "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-gray-900 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-yellow-600 dark:hover:text-yellow-500"
                                  : "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-gray-900 dark:text-gray-200 hover:bg-slate-50 dark:hover:bg-slate-700 hover:text-emerald-600 dark:hover:text-emerald-500"
                              }`}
                            >
                              {testType.isActive === 1
                                ? "Deactivate"
                            ...
                            <button
                              ...
                              className="flex items-center gap-1.5 px-4 py-2 bg-slate-100 dark:bg-slate-700 text-gray-900 dark:text-gray-200 rounded-lg hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 transition-colors text-sm font-medium"
                            >
          ...
          {canEdit && (
            <div className="mt-6">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-slate-100 dark:bg-slate-700 text-gray-900 dark:text-gray-200 rounded-lg hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600 transition-colors text-sm font-semibold shadow-sm border border-slate-200 dark:border-transparent leading-tight"
              >
