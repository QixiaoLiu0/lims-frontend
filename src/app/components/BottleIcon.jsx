...
export function BottleIcon({
  ...
  const fillPercentage = Math.min(
    100,
    Math.max(0, (remainingVolume / maxVolume) * 100),
  );
  ...
  return (
    <div className="dark:bg-slate-600 dark:text-white flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
      {/* Bottle SVG */}
      <div className="relative" style={{ width: "32px", height: "48px" }}>
        ...
        >
          ...
          {/* Cap */}
          <rect x="11" y="0" width="10" height="4" rx="1" fill="#64748b" />
        </svg>
      </div>

      {/* Volume info and edit */}
      <div className="flex-1 ">
        <div className="text-xs text-gray-600 dark:text-white mb-1">Remaining</div>
        {isEditing ? (
          <div
