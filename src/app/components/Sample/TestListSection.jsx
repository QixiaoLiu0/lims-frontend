  ...
  if (testCardData.length === 0) {
    return (
      <div className="bg-white dark:bg-slate-800 rounded-xl p-8 shadow-sm border border-slate-200 dark:border-slate-700 text-center">
        ...
        <p className="text-sm font-medium leading-normal text-gray-500 dark:text-gray-200 mb-6 max-w-md mx-auto">
        ...
        return (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              <h3
                className="font-bold text-gray-900 dark:text-gray-200 text-lg leading-tight flex-1 cursor-pointer line-clamp-2"
            ...
            <div
              ...
              onClick={() => goToTestDetail(test.testId)}
            >
              <span className="inline-block px-2.5 py-0.5 rounded-full text-xs font-semibold leading-tight bg-slate-100 text-gray-900 dark:bg-gray-900 dark:text-gray-200 border border-slate-200 dark:border-slate-600">
                {test.typeName || "Other"}
              </span>
            </div>
            ...
            <div className="flex items-center justify-between text-sm mb-3">
              <span className="font-medium text-gray-500 dark:text-gray-200 leading-tight">
                Run #:
              </span>
            ...
            <div
              ...
              onClick={() => goToTestDetail(test.testId)}
            >
              <button className="text-gray-500 dark:text-gray-200 group-hover:text-blue-500 dark:group-hover:text-blue-500 transition-colors text-sm font-medium leading-tight flex items-center gap-1.5">
